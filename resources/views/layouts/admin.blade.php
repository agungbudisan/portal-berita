    ...
    <div class="row g-0">
        ...
        <div class="col-md-2 dashboard-sidebar">
            ...
            <ul class="nav flex-column dashboard-menu">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('admin.api-sources.*') ? 'active' : '' }}" href="{{ route('admin.api-sources.index') }}">
                        <i class="bi bi-gear me-2"></i> Pengaturan API
                    </a>
                </li>
            </ul>

            <p class="text-muted small mb-2 mt-4">AKUN</p>
            <ul class="nav flex-column dashboard-menu">
                <li class="nav-item">
        ...
        <div class="col-md-10 bg-light">
            ...
            <div class="d-flex justify-content-between align-items-center p-3 bg-white border-bottom">
                <h5 class="m-0">@yield('header', 'Dashboard Admin')</h5>
