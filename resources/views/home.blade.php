...
<div class="row">
    ...
    <div class="col-lg-8">
        ...
        <div class="hero-section">
            <div class="row">
                <div class="col-md-5">
                    <div class="rounded" style="height: 240px; background-image: url('{{ $featuredNews->image ? (Str::startsWith($featuredNews->image, 'http') ? $featuredNews->image : asset('storage/'.$featuredNews->image)) : asset('images/placeholder.jpg') }}'); background-size: cover; background-position: center;"></div>
                </div>
                <div class="col-md-7">
