                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="url" class="form-control @error('image_url') is-invalid @enderror" id="image_url" name="image_url" value="{{ old('image_url', $news->image_url) }}" required oninput="previewImageUrl()">
                                @error('image_url')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div id="image-preview-container" class="mt-2">
                                <img src="{{ old('image_url', $news->image_url) }}" alt="{{ $news->title }}" class="img-fluid rounded"
                                    id="image-preview" style="max-height: 200px; width: auto;">
                            </div>
                        </div>
                    </div>
